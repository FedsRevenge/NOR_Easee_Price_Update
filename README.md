...
Run the script manually the first time as it will set up the values for location, costs and API tokens.
After that you can set it up to run once each hour, personally I use a Raspberry Pi.
